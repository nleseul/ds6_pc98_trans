...
def program_disk_patch_combat_text(program_disk_patch):
    ...
    battle_text_translations = [
        ...
        { 'orig_addr': 0xa6f9, 'orig_length': 0x1e, 'translation': "Inside the <X0e>, there<RETN>\n<CONT>was a <X0e>!", 'references': [ 0xa6e3 ] },
        ...
        { 'orig_addr': 0xaf1f, 'orig_length': 0x1e, 'translation': "<X02> finds 50 gold.<X0c0301><X0a>", 'references': [ 0xaf08 ] },
